...
\lstdefinestyle{cmdblock}{
	...
	backgroundcolor=\color[HTML]{CCE7E2} % lighter version of KIT green, created with help of https://www.tutorialrepublic.com/html-reference/html-color-picker.php
}
